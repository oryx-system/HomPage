...
export const FEATURES: Feature[] = [
  {
    title: "생체 인식 검증",
    description: "생체 인식 통합을 포함한 다중 요소 인증을 통해 21 CFR Part 11의 전자서명 부인 방지 기능을 완벽히 보장합니다.",
  ...
  {
    title: "데이터 무결성 (ALCOA+)",
    description: "기록의 귀속성, 판독성, 동시성, 원본성 및 정확성(ALCOA+)을 수명 주기 전반에 걸쳐 보장합니다.",
  ...
  },
  {
    ...
    description: "글로벌 GxP 표준을 충족하는 역할 기반 접근 제어(RBAC)와 최고 수준의 암호화 기술을 적용합니다.",
    icon: <Lock className="w-6 h-6 text-red-400" />
  },
  {
    title: "밸리데이션 즉시 대응",
    description: "VMP(Validation Master Plan) 및 IQ/OQ/PQ 프로토콜이 포함된 사전 검증된 플랫폼을 제공합니다.",
