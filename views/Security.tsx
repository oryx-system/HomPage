          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-500 mb-8 leading-relaxed font-medium">
                Oryx DataSafe는 단순한 문서 저장소가 아닙니다. 데이터 무결성의 핵심인 ALCOA+ (Attributable, Legible, Contemporaneous, Original, Accurate+) 원칙을 시스템 기능으로 직접 구현하였습니다.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-6 bg-blue-50 rounded-3xl border border-blue-100 text-center">
                ...
                <p className="text-[10px] text-slate-500 uppercase tracking-widest">Ready</p>
              </div>
            </div>
          </div>
        </motion.div>
