      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-32">
          <div>
            ...
            <h1 className="text-6xl font-bold mb-8 leading-tight">현장의 언어를 아는 <br /> 규제 준수 솔루션.</h1>
            ...
            <div className="grid grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 uppercase font-bold tracking-widest">전 장비 연동 프로토콜 확보</p>
              </div>
            </div>
          </div>
          <div className="relative">
             <div className="aspect-square glass rounded-[60px] flex items-center justify-center p-12 border-white/5 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                   ...
                   <p className="text-xl font-medium text-gray-300 italic mb-4">"현장 설비의 데이터는 거짓말을 하지 않습니다."</p>
                   <p className="text-sm text-gray-500">Oryx DataSafe Founder & Chief Engineer</p>
                </div>
             </div>
        ...
        <div className="p-12 glass rounded-[40px] border-white/10 mb-24 bg-gradient-to-br from-blue-900/10 to-transparent">
           ...
           <div className="grid md:grid-cols-3 gap-12">
              <div className="space-y-4">
                 <h4 className="text-blue-400 font-bold">현장 프로토콜의 완벽한 이해</h4>
                 <p className="text-sm text-gray-500 leading-relaxed">Modbus, EtherCAT, Profibus 등 다양한 산업용 프로토콜에 대한 깊은 이해를 바탕으로 외산/국산 모든 장비와 데이터 연동을 보장합니다.</p>
              </div>
              <div className="space-y-4">
