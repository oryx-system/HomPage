           ...
           <div className="grid md:grid-cols-4 gap-8 relative z-10">
              {[
                ...
                <div key={i} className="text-center group/item">
                   <div className="w-14 h-14 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-blue-400 font-black text-xl mb-6 mx-auto group-hover/item:bg-blue-600 group-hover/item:text-white transition-all">
                      {item.step}
                   </div>
                   ...
                   {i < 3 && (
                     <div className="hidden md:block absolute top-7 translate-x-[110px] w-20 h-[1px] bg-white/10" />
                   )}
                </div>
              ))}
           </div>
